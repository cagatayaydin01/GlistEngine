...
On Windows:
>  git clone https://github.com/cagatayaydin01/glistzbin-win64.git

On MacOS:
>  git clone https://github.com/cagatayaydin01/glistzbin-macos.git

On Linux:
>  git clone https://github.com/cagatayaydin01/glistzbin-linux.git
